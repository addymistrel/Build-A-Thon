...
const NurseRegistration = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.Exp) newErrors.drivingExp = "Experience is required";
    if (
      !/^(([A-Z]{2}[0-9]{2})|([A-Z]{2}-[0-9]{2}))((19|20)[0-9]{2})[0-9]{7}$/.test(
        formData.NUID
      )
    ) {
      newErrors.NUID= "DL is required";
    }
    if (
      ...
      newErrors.UHID = "Invalid Vehicle Number Plate";
      ...
      <Container className="container-reg" maxW="75%" mt={8}>
        ...
        >
          <Box flex={1} p={8}>
            ...
            <Text className="text">
              Step into AidG, where your commute becomes a canvas of
            ...
            <Image
              p={2}
              src="/assets/nurseRegistration.gif"
              alt="Background GIF"
            />
          </Box>
          <Box
          ...
          >
            ...
            <Box mt={4}>
              ...
              <FormControl mt={4} isRequired isInvalid={!!errors.carNumber}>
                <FormLabel>Nurse Unique Identification Number (NUID)</FormLabel>
                <Input
                  type="text"
                  placeholder="Enter NUID"
                  value={formData.NUID}
                  onChange={(e) =>
                    setFormData({ ...formData, NUID: e.target.value })
                  }
                />
                <FormErrorMessage>{errors.NUID}</FormErrorMessage>
              </FormControl>

              <FormControl mt={4} isRequired isInvalid={!!errors.dlNumber}>
                <FormLabel>Unique Hospital ID (UHID)</FormLabel>
                <Input
                  type="text"
                ...
                />
                <FormErrorMessage>{errors.UHID}</FormErrorMessage>
              </FormControl>

              <FormControl mt={4} isRequired isInvalid={!!errors.drivingExp}>
                <FormLabel>Working Experiance</FormLabel>
                <Select
