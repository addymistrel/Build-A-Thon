  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyCDWCrB98FdhjCbdoZYNsR9dhdUQ-bQ3S8`,
        method: "post",
        data: {
      ...
      <div className="bg-white h-screen p-3">
        ...
        >
          <a href="https://github.com/Vishesh-Pandey/chat-ai" target="_blank">
            <h1 className="text-3xl text-center">Ask Any Query</h1>
          </a>
          <textarea
            required
