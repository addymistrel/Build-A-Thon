...
const features = [
  {
    title: 'Simple UI/UX',
    detail: 'Create an intuitive UI with clear navigation and minimalistic design',
    icon: (
      <svg
        aria-hidden="true"
        role="img"
  ...
  {
    title: 'Easy to Use ',
    detail: 'Works on voice recognition with simple features like audio',
    icon: (
      <svg
        aria-hidden="true"
        role="img"
        ...
        <Stack direction={{ base: 'column', md: 'row' }}>
          <Stack direction="column" spacing={10} justifyContent="center">
            ...
            <Text
              ...
              maxW="700px"
            >
              Voice and NFC payment integration revolutionizes the transaction process by combining the ease of voice commands with the convenience of contactless NFC technology. Users can securely authorize payments simply by speaking commands or tapping their device, eliminating the need for physical cards or manual input. This seamless fusion of advanced technologies not only enhances user convenience but also ensures efficient and secure transactions, shaping the future of digital payments.
            </Text>
            <Stack
            ...
            >
              <chakra.button
                ...
                mb={{ base: 2, sm: 0 }}
              >
                <chakra.span> Download </chakra.span>
              </chakra.button>
              {/* <Flex
                border="1px solid"
